...
export const SearchBox = (props: Props) => {
    ...
    return(
        <Popup open={showSearch} closeOnDocumentClick={false} contentStyle={{height: '100%', width: '100%', display: 'flex'}}>
            <div className="text-white h-auto w-72 px-5 mx-auto shadow-2xl rounded-xl bg-slate-800 z-30 lg:hidden overflow-hidden self-center">
